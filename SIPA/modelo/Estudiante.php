...
//        
        $sql ="WITH funcionario as (
                   INSERT INTO usuario(id, nombre, apellido, telefono, cuenta, contrasena,rol)
                      VALUES ('$id', '$nombre', '$apellido','$telefono', '$cuenta','$contrasena','estudiante') RETURNING id
                ) INSERT INTO estudiante (cod_estudiante,usuario_id,fk_practica) VALUES ((SELECT id FROM funcionario), '$cod_estudiante',$practica);";
        error_log($sql);
